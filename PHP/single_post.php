<?php 
	...
	$login = new Login();
	$user_data = $login->check_login($_SESSION['TravelBlog_userid']);
...
<!DOCTYPE html>
	<html>
	<head>
		<title>Single Post | TravelBlog</title>
	</head>
	...
	<body style="font-family: tahoma; background-color: #d0d8e4;">
		...
		<!--post area-->
	<?php if(!($is_group_post && $group_data['group_type'] == 'private' && !group_access($_SESSION['TravelBlog_userid'],$group_data,'member'))): ?>
...
<?php if($ROW['parent'] == 0): ?>
	...
	<?php if(!($is_group_post && $group_data['group_type'] == 'public' && !group_access($_SESSION['TravelBlog_userid'],$group_data,'member'))): ?>
