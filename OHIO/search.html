...
<body>
  ...
  <div class="navbar">
    ...
    <div class="nav-links">
      <a style="font-weight: bold; color:white;" href="../OHIO/index.html">Home</a>
      <a style="font-weight: bold; color:white;" href="../Login/Login.html">Login</a>
    </div>
  </div>
  <div class="container">
    <a href="../OHIO/viewpost_anon.html" class="white-box">
      <div class="box-text">
        <h2>Bangkok</h2>
